import styles from "../css/MarqueeClientes.module.css";
import { useContent } from "./Sistemas/useContent.tsx";
import LazyImage from './Sistemas/LazyImage.tsx';

function MarqueeClientes() {
    const content = useContent();

    // Obtener items desde el contenido
    const generalItems = content?.home.MarqueeClientes.common.items ?? [];
...
export default MarqueeClientes;
